...
export default function Posts() {
    return (
        <div className={styles.posts}>
            <Post imageUrl="https://media4.giphy.com/media/BzyTuYCmvSORqs1ABM/giphy.gif?cid=ecf05e47jmerhdcnywqdse7oy94srw2zltkw49iu0htkhx8i&rid=giphy.gif&ct=g" title="[코드업] 문제 풀이 노트" text="코드업 문제집 풀면서 놓쳤던 문제 정리! 하루 5문제씩 업데이트됨" src="/codeup" />
